...
const textTranslations = {
  ...
  '永磁变频高压清洗机，专为高效清洁而生': 'PM inverter pressure washers for efficient cleaning',
  '从 P4/P5 入门家用手提款，到 PH 系列高级家用与半商用机型，再到 VK 系列商用级和清洗机爱好者产品，\n            磐宏按不同使用需求提供清晰选型。其中 VK-Y1 主打新能源汽车外放电与永磁变频技术，是移动清洗和高频使用场景的重点推荐款。':
    'From entry handheld P4/P5 models to PH home and semi-commercial machines, Panhiro makes pressure washer selection clear. VK-Y1 adds EV power output and PM inverter control for mobile, high-frequency cleaning.',
...
const supplementalTranslations = {
  ...
  关闭视频: 'Close video',
  页面详情: 'Page details',
  '磐宏清洗设备 | 永磁变频高压清洗机制造商': 'Panhiro Pressure Washer Manufacturer | EV Powered and Commercial Cleaning Machines',
  ...
  高压启动: 'Pressure Ready',
  清洁登场: 'Clean Faster',
  '高压启动，清洁登场': 'Pressure ready. Clean faster.',
